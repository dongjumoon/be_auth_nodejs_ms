...
class BoardRoute implements Route {
  ...
  private initializeRoutes() {
    ...
    this.router.get(`${this.path}/detail/:bno`, this.BoardController.getBoardDetail); // 게시글 상세목록
    ...
    this.router.delete(`${this.path}/:bno`, this.BoardController.deleteBoard); // 게시글 삭제
  }
}
